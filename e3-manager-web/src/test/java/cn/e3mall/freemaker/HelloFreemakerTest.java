...
public class HelloFreemakerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("E:/java课程/workspace/JAVAEE32/e3-manager-web/src/main/webapp/WEB-INF/ftl"));
...
//		Writer out = new FileWriter(new File("D:/temp/JavaEE32/freemarker/hello.txt"));
		Writer out = new FileWriter(new File("F:/00JAVA/temp/student.html"));
		//8、生成静态页面
